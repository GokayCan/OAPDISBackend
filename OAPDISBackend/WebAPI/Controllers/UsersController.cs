...
namespace WebAPI.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpPost("[action]")]
        public async Task<IActionResult> UpdatePersonalInformation(UserDto user)
        {
            var result = await _userService.UpdatePersonalInformation(user);
            if (result.Success)
            {
                return Ok(result);
            }
        ...
        [HttpPost("[action]")]
        public async Task<IActionResult> UpdatePassword(UserChangePasswordDto user)
        {
        ...
        [HttpPost("[action]")]
        public async Task<IActionResult> UpdateProfilePhoto([FromForm] UserPhotoDto user)
        {
            var result = await _userService.UpdateProfilePhoto(user);
            if (result.Success)
            {
                return Ok(result);
            }
