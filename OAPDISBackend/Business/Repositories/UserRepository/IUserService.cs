...
namespace Business.Repositories.UserRepository
{
    ...
    {
        Task<IDataResult<User>> Add(UserDto userDto);
        ...
        Task<IResult> UpdatePersonalInformation(UserDto userDto);

        Task<IResult> UpdatePassword(UserChangePasswordDto userDto);

        Task<IResult> UpdateProfilePhoto(UserPhotoDto userDto);
    }
}